...
def create_formatter(theme, base_format, delimiter=None):
    ...
    styles = theme['styles']
    included_parts = theme.get('included_parts', ['time', 'level', 'message'])
    ...
    def formatter(record):
        ...
        for part in parts_order:
            ...
            elif part == 'module_part' and 'module' in included_parts:
            ...
            elif part == 'function_part' and 'function' in included_parts:
            ...
            elif part == 'line_part' and 'line' in included_parts:
                line_color = hex_to_ansi(theme.get('line_color', '#FFFFFF'))
                parts_list.append(f"{line_color}{record['line']}{reset}")
            elif part == 'thread_name_part' and 'thread_name' in included_parts:
            ...
            elif part == 'process_name_part' and 'process_name' in included_parts:
            ...
            elif part == 'message_part' and 'message' in included_parts:
